...
import com.br.helpdesk.api.repository.ChangeStatusRepository;
import com.br.helpdesk.api.repository.TicketRepository;
...
public class TicketServiceImpl implements TicketService{
	...
	@Override
	public Page<Ticket> findByParameterAndAssingnedUser(int page, int count, String title, String status,
